...
export function Connect() {
  ...
  return (
    <section className="relative mx-auto mb-0 mt-6 max-w-6xl">
                ...
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  <div className="relative mx-auto h-[270px] w-[300px] md:h-[270px] md:w-[300px]" ref={scope}>
                    ...
                    <div id="pointer" className="absolute">
                      ...
                      <span className=" relative -top-1 left-3 rounded-3xl px-2 py-1 text-xs text-white"></span>
                    </div>
                  </div>
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    <div className="flex flex-col items-left">
                      <h3 className="mt-6   pb-1 font-bold ">
                        <span className="text-2xl md:text-4xl">Still have quries?</span>
                      </h3>
                    </div>
                    <p className="mb-4 text-slate-400">Feel free to reach out to us!</p>
                    <div className="flex flex-wrap gap-2">
                      ...
                      >
                        <span className="flex items-center gap-1">
                          <WhatsApp strokeWidth={1} className="h-4 w-4" />
                        </span>
                      </Link>
                    </div>
                  </div>
